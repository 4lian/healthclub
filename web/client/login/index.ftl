        ...
        <div id="container_demo">
            ...
            <div id="wrapper">
                <div id="login" class="animate form">
                    <form action="/index/doLogin" autocomplete="on" method="post">
                        <h1>Log in</h1>
                        ...
                        <p class="change_link">
                            Not a member yet ?
                            <a href="#toregister" class="to_register" clear_back="clear_back">Join us</a>
                        </p>
                    </form>
                </div>

                <div id="register" class="animate form">
                    <form action="/index/doSignup" autocomplete="on" method="post">
                        <h1> Sign up </h1>
                        ...
                        <p>
                            <label for="role" class="role">用户类型</label>
                        ...
                        <p class="change_link">
                            Already a member ?
                            <a href="#tologin" class="to_register" clear_back="clear_back"> Go and log in </a>
                        </p>
                    </form>
                </div>
...
<#include "/lib/js_lib.ftl">
<script type="application/javascript" src="/js/client/login/login.js"></script>
</body>
</html>